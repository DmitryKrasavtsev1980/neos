...
use App\Filament\Resources\FeatureComponentResource\Pages;
use App\Filament\Resources\FeatureComponentResource\RelationManagers;
...
class FeatureComponentResource extends Resource
{
    protected static ?string $model = FeatureComponent::class;
    ...
    public static function getTemplateClasses(): Collection
    {
        ...
        return collect($filesystem->allFiles(app_path('Filament/Resources/FeatureComponentResource/PageTemplates')))
            ->map(function (SplFileInfo $file): string {
                return (string) Str::of('App\\Filament\\Resources\\FeatureComponentResource\\PageTemplates')
    ...
    {
        return [
            'index' => Pages\ListFeatureComponents::route('/'),
            'create' => Pages\CreateFeatureComponent::route('/create'),
            'edit' => Pages\EditFeatureComponent::route('/{record}/edit'),
        ];
    }
}
