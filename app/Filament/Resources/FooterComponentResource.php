...
use App\Filament\Resources\FooterComponentResource\Pages;
use App\Filament\Resources\FooterComponentResource\RelationManagers;
...
class FooterComponentResource extends Resource
{
    protected static ?string $model = FooterComponent::class;
    ...
    public static function getTemplateClasses(): Collection
    {
        ...
        return collect($filesystem->allFiles(app_path('Filament/Resources/FooterComponentResource/PageTemplates')))
            ->map(function (SplFileInfo $file): string {
                return (string) Str::of('App\\Filament\\Resources\\FooterComponentResource\\PageTemplates')
    ...
    {
        return [
            'index' => Pages\ListFooterComponents::route('/'),
            'create' => Pages\CreateFooterComponent::route('/create'),
            'edit' => Pages\EditFooterComponent::route('/{record}/edit'),
        ];
    }
}
