...
use App\Filament\Resources\TextBlockComponentResource\Pages;
use App\Filament\Resources\TextBlockComponentResource\RelationManagers;
...
class TextBlockComponentResource extends Resource
{
    protected static ?string $model = TextBlockComponent::class;

    protected static ?string $navigationIcon = 'heroicon-o-arrow-sm-right';

    protected static ?string $navigationLabel = 'TextBlock';
    ...
    public static function getTemplateClasses(): Collection
    {
        ...
        return collect($filesystem->allFiles(app_path('Filament/Resources/TextBlockComponentResource/PageTemplates')))
            ->map(function (SplFileInfo $file): string {
                return (string) Str::of('App\\Filament\\Resources\\TextBlockComponentResource\\PageTemplates')
    ...
    {
        return [
            'index' => Pages\ListTextBlockComponents::route('/'),
            'create' => Pages\CreateTextBlockComponent::route('/create'),
            'edit' => Pages\EditTextBlockComponent::route('/{record}/edit'),
        ];
    }
}
