...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value sets the middleware that will be applied to the main Livewire
    | "message" endpoint (the endpoint that gets hit everytime a Livewire
    | component updates). It is set to "web" by default.
    |
    */
    ...
    | items below are used for customizing the way the endpoint handles
    | file uploads.
    |
    */
