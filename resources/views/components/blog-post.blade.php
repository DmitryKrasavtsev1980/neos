<div class="bg-white rounded-lg">
    ...
    <div class="overflow-hidden">
        <div class="relative mx-auto max-w-7xl py-16 px-6 lg:px-8">
            <div class="absolute top-0 bottom-0 left-3/4 hidden w-screen lg:block"></div>
            <div class="mx-auto max-w-prose text-base lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-8">
                <div>
                    <h2 class="text-lg font-semibold flex flex-nowrap align-middle">
                        @if($post->title)
                    ...
                    @if($post->title)
                        <h3 class="mt-2 text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">{{ $post->title }}</h3>
                    @endif
                </div>
            </div>
            <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
                    ...
                    <div class="relative mx-auto max-w-prose text-base lg:max-w-none">
                        <figure>
                            <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
                                <img class="rounded-lg object-cover object-center shadow-lg" src="{{ $post->image }}" width="1184" height="1376">
                            </div>
                ...
                <div class="mt-8 lg:mt-0">
                    <div class="mx-auto max-w-prose text-base lg:max-w-none">
                        @if($post->subtitle)
                            <p class="text-lg text-gray-500">{{ $post->subtitle }}</p>
                        @endif
                    </div>
